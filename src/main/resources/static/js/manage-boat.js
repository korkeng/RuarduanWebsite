...
function changeViewSchedule() {
       $.ajax({
        type: "GET",
        url: "http://139.99.117.190:8080/schedules",
        dataType: 'json',
        success: function (data) {
            ...
            if (document.getElementById("dataTable").rows.length == 0) {
                    ...
                    for(j = 0; j < dataHeader.length; j++){     
                        ...
                        switch(j) {
                            ...
                            case 6:
                                ...
                                break;
                            case 7:
                                cellData[j].innerHTML = "<span class=\"table-edit\"><button type=\"button\" class=\"btn btn-warning btn-rounded btn-sm my-0\" onclick=\"editRole("+data[i].scheduleId+")\">Edit</button></span>";
                                break;
                            case 8:
                                cellData[j].innerHTML = "<span class=\"table-remove\"><button type=\"button\" class=\"btn btn-danger btn-rounded btn-sm my-0\" onclick=\"deleteRole("+data[i].scheduleId+")\">Delete</button></span>";
                                break;
                        } 
                    }        
                }
                tableData = $('#dataTable').DataTable();
                dataLength = data.length;  
                document.getElementById("tableAddData").innerHTML = "<button type=\"button\" class=\"btn\" id=\"addDataButton\" onclick=\"addSchedule()\">"+
                                                                    "ADD SCHEDULE"+
                                                                    "</button>";                 
            } else {
                tableData.destroy();
            ...
            if(objectBoatType.boattypeId.boattype_id != "" && objectBoatType.boattypeId.boattypeLanguages != "" &&
                objectBoatType.name != ""){
                    $.ajax({
                        ...
                        url : "http://139.99.117.190:8080/boattype",
            ...
            if(objectRoute.routeId.route_id != "" && objectRoute.routeId.routeLanguages != "" &&
                objectRoute.routeName != ""){
                    $.ajax({
                        type : "POST",
                        contentType : "application/json",
                        url : "http://139.99.117.190:8080/route",
...
function editBoatType(id,lan){
    ...
    $.ajax({
        type: "GET",
        url: "http://139.99.117.190:8080/boattypes/"+lan+"/"+id.toString(),
        dataType: 'json',
        success: function (data) {
    ...
    btnclose.onclick = function() {
        ...
        var objectBoatType = {
            ...
            $.ajax({
                type : "PUT",
                contentType : "application/json",
                url : "http://139.99.117.190:8080/boattypes/update/"+lan+"/"+id.toString(),
                data : JSON.stringify(objectBoatType),
                dataType : 'json',
                success : function() {
                    swal({
...
function editRoute(id,lan){
    ...
    $.ajax({
        type: "GET",
        url: "http://139.99.117.190:8080/routes/"+lan+"/"+id.toString(),
        dataType: 'json',
        success: function (data) {
    ...
    btnclose.onclick = function() {
        ...
        var objectRoute = {
            ...
            $.ajax({
                type : "PUT",
                contentType : "application/json",
                url : "http://139.99.117.190:8080/route/update/"+lan+"/"+id.toString(),
                data : JSON.stringify(objectRoute),
                dataType : 'json',
                success : function() {
                    swal({
...
function deleteBoatType(id,lan){
    swal({
        ...
        $.ajax({
            type : "DELETE",
            contentType : "application/json",
            url : "http://139.99.117.190:8080/boattype/"+lan+"/"+id,
            dataType : 'json',
            success : function() {
                swal(
                    'Successful',
...
function deleteRoute(id,lan){
    swal({
        ...
        $.ajax({
            type : "DELETE",
            contentType : "application/json",
            url : "http://139.99.117.190:8080/route/"+lan+"/"+id,
            dataType : 'json',
            success : function() {
                swal(
                    'Successful',
